	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('{{ asset('authen/images/bg-01.jpg') }}');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form class="login100-form validate-form p-b-33 p-t-5"method="POST" action="{{ route('password.store') }}">
                    @csrf
        ...
        <input type="hidden" name="token" value="{{ $request->route('token') }}">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Enter Email">
						<input class="input100" type="text" name="email" value="{{ $request->email }}" placeholder="Email">
